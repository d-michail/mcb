...
void run_and_display(GraphWin& gw) { 
    ...
    int w = mcb::DMCB_APPROX( G, len, k , mcb, enumb, errorp );
...
int main(int argc, char *argv[])
{
    ...
    GraphWin gw(G,"Approximate Directed Minimum Cycle Basis");

    gw.add_help_text("GW_UNIFORM_DMCB_APPROX");
    gw.display();
    gw.display_help_text("GW_UNIFORM_DMCB_APPROX");
