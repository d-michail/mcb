...
namespace mcb
{
    ...
    extern void MCB_output_basis( const leda::graph & g,
				  const leda::array < leda::list <
				  leda::edge > >&mcb, const edge_num & enumb,
				  leda::array < leda::d_int_set > &C );
    ...
    extern int MIN_CYCLE_BASIS_DEPINA( const leda::graph & g,
				       leda::array < leda::list < leda::edge >
				       >&mcb,
				       leda::array < leda::list < leda::edge >
				       >&proof );
    ...
    extern void MCB_construct_superset( const leda::graph & G,
					leda::sortseq < leda::two_tuple < int,
					int >, leda::d_int_set > &super,
					const edge_num & enumb );
	...
	return MIN_CYCLE_BASIS_DEPINA_CHECK( g, len, mcb_temp, proof_temp,
					     enumb );
    }
