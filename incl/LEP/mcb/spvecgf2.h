...
namespace mcb
{
	...
	public:
	     ...
	     *  necessary unless insert or append were called in wrong order. Note that
	     *  this function does not make sure the entries are unique.
	     */
	    void sort() { l.sort(); }
