...
#line 1137 "MIN_CYCLE_BASIS.lw"
     ...
     *
     *  This class is implemented internally by double linked lists. Operations 
     *  append and insert takes constant time but does not ensure the correct ordering of the elements.
     *
     *  Most binary operations take time proportional to the number of elements in the list.
