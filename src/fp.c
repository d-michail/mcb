...
appending on spvecfp: out-of-bounds" );
    ...
    indextype spvecfp::size(  ) const
    {
	return l.size(  );
    }
    indextype spvecfp::max_length(  ) const
    {
	return len;
    }
    ptype spvecfp::pvalue(  ) const
    {
	return p;
    }
    list_item spvecfp::first(  ) const
    {
	return l.first(  );
    }
    list_item spvecfp::last(  ) const
    {
	return l.last(  );
    }
    list_item spvecfp::succ( list_item it ) const
    {
	return l.succ( it );
    }
    list_item spvecfp::pred( list_item it ) const
    {
	return l.pred( it );
    }
    indextype spvecfp::index( list_item it ) const
    {
	return l.contents( it ).first(  );
    }
    ptype spvecfp::inf( list_item it ) const
    {
	return l.contents( it ).second(  );
    }
